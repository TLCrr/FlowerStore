...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl">
            <span class="logo navbar-slogan f-l mr-10 hidden-xs">欢迎进入花店管理系统</span class="logo navbar-slogan f-l mr-10 hidden-xs">
    ...
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-product">
            ...
            <dd>
                <ul>
                    <li>
                        <a data-href="FlowerServlet?method=show&username=${sessionScope.SESSION_user.username}" data-title="查看鲜花" href="javascript:void(0)">所有鲜花</a>
                    </li>
                </ul>
            </dd>
        </dl>
        ...
        <dl id="menu-tongji">
            ...
            <dd>
                <ul>
                    <li>
                        <a data-href="FlowerServlet?method=showcart&username=${sessionScope.SESSION_user.username}"data-title="购物车" href="javascript:void(0)">购物车</a>
                    </li>

                </ul>
            </dd>
        </dl>
        <dl id="menu-system111">
            <dt>本店留言</dt>
            <dd>
                <ul>
                    <li>
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            <iframe scrolling="yes" frameborder="0" src="FlowerServlet?method=show&username=${sessionScope.SESSION_user.username}"></iframe>
        </div>
    </div>
</section>
